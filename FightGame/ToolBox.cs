...
public class ToolBox
{
    public static void Save(
        ...
        int MP,
        int maxMP,
        int defeatedPokemonCount
    )
    {
        //Convers all ints to strings
        string[] saveStats =
        {
            maxPokermonHealth.ToString(),
            enemyMaxHealth.ToString(),
            pokermonHealth.ToString(),
            enemyHealth.ToString(),
            baseDamage.ToString(),
            enemyBaseDamage.ToString(),
            MP.ToString(),
            maxMP.ToString(),
            defeatedPokemonCount.ToString(),
        };
...
1.Attack, 2.Power attack (-20mp), 3.Heal 10-25hp (-20mp), 4.Regen mana (+20mp), 5.Check counter"
    ...
    public static int[] UpgradeCheck(
        int upgradeChoice,
        int maxPokermonHealth,
        int baseDamage,
        int maxMP,
